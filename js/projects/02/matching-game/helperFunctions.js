...
var makeGameBoard = function(boardSize) {
  ...
  for(var i = 0; i < boardSize; i++) {
    ...
    for(var j = 0; j < boardSize; j++) {
      var telegraphBlue1 = 'DarkSeaGreen'; //these are 'hex' representations of colors. It's just a way of telling the machine exactly what shade of blue we want.
      var telegraphBlue2 = 'IndianRed';
